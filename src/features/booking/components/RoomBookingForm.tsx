        ...
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1fr)_22rem]">
            <form className="min-w-0 space-y-14" noValidate onSubmit={handleSubmit}>
                ...
                <ScheduleSection
                    ...
                    uid={uid}
                />
                <EventDetailsSection setField={setField} state={state} uid={uid} />
                <NeedsSection setField={setField} state={state} uid={uid} />
                <CateringBarSection setField={setField} state={state} uid={uid} />
                <TicketSection setField={setField} state={state} uid={uid} />
                <ContactSection setField={setField} state={state} uid={uid} />
