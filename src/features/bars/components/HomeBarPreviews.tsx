...
function hasSpotifyTrack(nowPlaying: NowPlayingState | null, room: HomeBarPreviewRoom) {
    return (
        room.slug === "grondahls" &&
...
export function HomeBarPreviews({ rooms, houseClosedDates, locale }: HomeBarPreviewsProps) {
