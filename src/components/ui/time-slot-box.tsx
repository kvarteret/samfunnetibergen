...
// 15-minute slots colored by availability (green = selectable, subtle red =
// already booked and disabled). Reused for the get-in/get-out boxes, which
// stay in sync with the range slider since both write through the same
// start/end change handlers.
    ...
    <Popover.Root>
      ...
      <Popover.Portal>
        <Popover.Positioner sideOffset={8}>
          <Popover.Popup className="z-[100] max-h-72 w-56 overflow-y-auto panel shadow-shadow p-2">
                ...
                <Popover.Close
                  className={cn(
                    ...
                    opt.availability === "available"
                      ...
                      : "cursor-not-allowed border-destructive/30 bg-destructive/10 text-foreground-muted",
                    opt.value === value &&
                      opt.availability === "available" &&
