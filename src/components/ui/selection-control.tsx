...
export const selectionControlVariants = cva(
  "cursor-pointer border-2 border-border bg-card text-foreground focus-brutal disabled:cursor-not-allowed disabled:opacity-45",
  {
    variants: {
      ...
      size: {
        none: "",
        default: "min-h-11 px-3 py-1.5 font-heading text-sm",
        square: "size-11 font-heading text-sm",
        fill: "min-h-11 flex-1 px-3 py-2.5 font-heading text-sm uppercase tracking-widest",
      },
    },
    compoundVariants: [
      {
