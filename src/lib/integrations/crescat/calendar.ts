...
const USER_AGENT = "Mozilla/5.0 (compatible; SamfunnetBot/1.0; +https://samfunnetibergen.no)"
...
export async function fetchVenueResources(calendarSlug: string): Promise<CresatResource[]> {
    try {
