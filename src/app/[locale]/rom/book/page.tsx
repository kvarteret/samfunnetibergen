...
export default async function BookRoomPage({ params }: { params: Promise<{ locale: string }> }) {
            ...
            <header className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                    <div className="size-10 bg-primary flex items-center justify-center shrink-0">
                        <CalendarCheck className="size-5 text-primary-foreground" aria-hidden />
                    </div>
                ...
                <p className="max-w-xl text-lg leading-7 text-foreground/70">
                    Fyll ut skjemaet under, så behandler vi forespørselen din så fort vi ser den. En
                    booking er en forespørsel og bekreftes av oss på e-post.
                </p>
            </header>
