                ...
                <div className="grid gap-6 lg:grid-cols-[1fr_auto]">
                    <div className="space-y-4">
                        ...
                        <p className="text-lg leading-7 text-foreground/70 max-w-xl">
                            Arrangerer du eller din organisasjon noe på Samfunnet i Bergen? Fyll ut
                            skjemaet nedenfor, så vurderer PR-gruppen innmeldingen og legger det til
                            i listen.
                        </p>
                    </div>

                    <div className="self-start border-2 border-border bg-card p-5 space-y-3 lg:min-w-64">
