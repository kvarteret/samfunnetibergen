          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-base leading-7 sm:text-lg">
                This page is intentionally small. It proves the component
                registry, theme tokens, Tailwind v4 setup, and Next 16 app
                router are all wired together without the default starter UI.
              </p>
            </div>
