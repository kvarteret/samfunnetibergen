...
type SanityArrangement = Awaited<
  ReturnType<typeof fetchPublishedArrangements>
>[number];
    ...
    <section className="border-b-2 border-border pb-10 pt-2">
      ...
      <div className="flex flex-col gap-6">
        <p className="max-w-2xl text-base leading-relaxed text-foreground/75">
          ...
          Kvarter. Som student i Bergen er det å bli frivillig på Samfunnet en
          fantastisk måte å sette ditt preg på studentlivet.
        </p>
        <p className="max-w-2xl text-base leading-relaxed text-foreground/75">
          Samfunnet i Bergen er studenthuset i Bergen og er et av Norges mest
          aktive kulturhus. Hvert år arrangeres det over 1500 arrangementer og
          alt blir driftet av frivillige studenter. Vi har tre barer som alle er
          frivilligdrevet samt utallige grupper for å dekke alle studenters
          behov. Samfunnet er et samlingssted for alle Bergens studenter om det
          er for morgenkaffen eller kveldsfesting!
        </p>
