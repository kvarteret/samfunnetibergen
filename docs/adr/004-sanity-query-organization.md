...
The project also has a separate src/studio/ directory for Studio configuration, including schemas, structure, actions, presentation, and i18n. This separation should remain:

* src/studio/ defines the CMS/editor experience.
* src/lib/sanity/ defines how the website/app reads from Sanity.
