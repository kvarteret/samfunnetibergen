      ...
      <form.Subscribe selector={(s: { values: FormState }) => s.values.dates}>
        {(dates: DateEntry[]) => (
          <div className="space-y-4">
            ...
            <button
              className="flex w-full cursor-pointer items-center justify-center gap-2 border-2 border-dashed border-border bg-card px-4 py-2.5 font-heading text-foreground-muted transition-colors hover:bg-muted hover:text-foreground focus-brutal"
