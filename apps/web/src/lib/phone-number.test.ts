...
describe("E.164 phone validation", () => {
  test.each(["+4740612345", "+447400123456"])(
    "accepts an international value: %s",
    value => {
      expect(isE164PhoneNumber(value)).toBe(true)
    },
  )

  test.each(["40612345", "4740612345", "+47123", "+04740612345"])(
    "rejects a non-E.164 or invalid value: %s",
    value => {
