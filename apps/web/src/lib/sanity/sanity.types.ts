...
// Query: *[    _type == "page"    && defined(slug.current)    && !(slug.current in ["arrangementer", "bli-frivillig", "grupper", "karaoke", "kontakt", "rom", "sponsorer"])  ] {    "slug": slug.current}
...
// Query: *[    _type == "page"    && slug.current == $slug    && !(slug.current in ["arrangementer", "bli-frivillig", "grupper", "karaoke", "kontakt", "rom", "sponsorer"])  ][0] {    _id,    "title": coalesce(title, "[Mangler tittel]"),    "slug": coalesce(slug.current, ""),    content}
