...
export function CheckboxSquare({
  ...
  return (
    <Checkbox.Root
      ...
      checked={checked}
      className="relative mt-0.5 flex size-5 shrink-0 cursor-pointer items-center justify-center rounded-base border-2 border-border bg-card outline-none aria-invalid:border-destructive aria-invalid:bg-destructive/5 group-hover:bg-muted data-checked:bg-primary data-disabled:cursor-not-allowed data-disabled:opacity-60 focus-visible:ring-3 focus-visible:ring-primary"
      disabled={disabled}
      id={id}
